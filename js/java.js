...
////////
else if (e.target.value=="OPT9"&&mn1.value==="OPT7"&&coc.value=="ebte4"){
...
if (mn2.value=="OPT9"&&coc.value=="metw1"&&mn6.value=="OPT24"){
